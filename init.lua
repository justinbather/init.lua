...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>fb", builtin.buffers, { desc = "[F]ind in buffers" })

			-- lightly advanced example of overriding default behavior and theme
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			-- statusline.setup({ use_icons = vim.g.have_nerd_font, is_enabled = true })
